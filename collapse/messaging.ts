...
export type CollapseProtocol = {
  ...
  [CollapseMessageType.OPEN_VIDEO]: {
    request: { type: CollapseMessageType.OPEN_VIDEO; listId: string; videoId: string };
    response: void;
  };
  [CollapseMessageType.DELETE_VIDEO]: {
    request: { type: CollapseMessageType.DELETE_VIDEO; listId: string; videoId: string };
    response: void;
  };
  ...
  [CollapseMessageType.RENAME_LIST]: {
    request: { type: CollapseMessageType.RENAME_LIST; listId: string; name: string };
    response: void;
  };
  [CollapseMessageType.MERGE_LISTS]: {
    request: { type: CollapseMessageType.MERGE_LISTS; targetId: string; sourceId: string };
